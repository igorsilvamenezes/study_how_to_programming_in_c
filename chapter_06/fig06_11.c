...
/* function to demonstrate s static local array */
void staticArrayInit( void )
{
	...
	printf( "nValues on entering staticArrayInit:\n" );
	...
	/* modify an output contents of array1 */
	for( i = 0; i <= 2; i++ ){
...
void automaticArrayInit( void )
{
	...
	printf( "\n\nValues on entering autometicArrayInit:\n" );
